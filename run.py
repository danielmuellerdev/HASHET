...
def main():
    ...
    # dataset_file_paths = os.listdir(c.INPUT_PATH) # original dataset
    ...
    dh.preprocess_data(dataset_file_paths, save_file=c.W2V_INPUT, is_custom_dataset=is_custom_dataset)
    ...
    # input_file = dataset_file_paths
    # print("> Preprocessing data for sentence embeddings")
    # dh.preprocess_data_for_sentence_embedding(input_file, is_custom_dataset=True)
