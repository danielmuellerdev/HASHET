...
if SENTENCE_ENCODING_MODEL == GUSE:
    ...
    TRANSFER_LEARNING_MODEL_WEIGHTS_FILE_PATH = SAVE_FOLDER + "TLweights.h5"
    FT_MODEL_JSON_FILE_NAME = SAVE_FOLDER + "FTmodel.json"
    FINE_TUNING_MODEL_WEIGHTS_FILE_PATH = SAVE_FOLDER + "FTweights.h5"
else:
    TL_MODEL_JSON_FILE_NAME = SAVE_FOLDER + "BERT_TLmodel.json"
    TRANSFER_LEARNING_MODEL_WEIGHTS_FILE_PATH = SAVE_FOLDER + "BERT_TLweights.h5"
    FT_MODEL_JSON_FILE_NAME = SAVE_FOLDER + "BERT_FTmodel.json"
    FINE_TUNING_MODEL_WEIGHTS_FILE_PATH = SAVE_FOLDER + "BERT_FTweights.h5"

MODEL_JSON_FILE_NAME = FT_MODEL_JSON_FILE_NAME
MODEL_WEIGHTS_FILE_NAME = FINE_TUNING_MODEL_WEIGHTS_FILE_PATH
